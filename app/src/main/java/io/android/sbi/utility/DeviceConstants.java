...
public class DeviceConstants {
    public static final String LOG_TAG = "AndroidSBI";
     ...
     */
    public final static String BIOMETRIC_SUBTYPE_FINGER_SLAP = "Slap";
    public final static String BIOMETRIC_SUBTYPE_FINGER_SINGLE = "Single";
    public final static String BIOMETRIC_SUBTYPE_FINGER_TOUCHLESS = "Touchless";
    public final static String BIOMETRIC_SUBTYPE_FACE = "Full face";
    public final static String BIOMETRIC_SUBTYPE_IRIS_SINGLE = "Single";
    public final static String BIOMETRIC_SUBTYPE_IRIS_DOUBLE = "Double";
