...
public class DeviceUtil {
    ...
    public DeviceUtil(String deviceUsage) {
        if (deviceUsage.equals(DeviceConstants.DeviceUsage.Registration.getDeviceUsage())) {
            ...
            FINGER_DEVICE_SUBTYPE = DeviceConstants.BIOMETRIC_SUBTYPE_FINGER_SLAP;
            IRIS_DEVICE_SUBTYPE = DeviceConstants.BIOMETRIC_SUBTYPE_IRIS_DOUBLE;
        } else {
            CERTIFICATION_LEVEL = DeviceConstants.CERTIFICATION_L1; //L0, L1, L2
            DEVICE_USAGE = DeviceConstants.DeviceUsage.Authentication;
            FINGER_DEVICE_SUBTYPE = DeviceConstants.BIOMETRIC_SUBTYPE_FINGER_SINGLE;
            IRIS_DEVICE_SUBTYPE = DeviceConstants.BIOMETRIC_SUBTYPE_IRIS_SINGLE;
        }
        FACE_DEVICE_SUBTYPE = DeviceConstants.BIOMETRIC_SUBTYPE_FACE;
    }
}
